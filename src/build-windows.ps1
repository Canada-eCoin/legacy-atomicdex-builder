...
$QtVersion = if ($env:QT_VERSION) { $env:QT_VERSION } else { $Toolchains.qt.windows.version }
$QtWindowsArch = if ($env:QT_WINDOWS_ARCH) { $env:QT_WINDOWS_ARCH } else { $Toolchains.qt.windows.arch }
